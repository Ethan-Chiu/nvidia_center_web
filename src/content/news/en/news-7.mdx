...
A total of five places are expected to be offered for this call-for-project. The committee will complete the review process and announce the results by November 30, 2024. The project can last up to 3 months, with a recommended start date no earlier than March 1, 2025.
